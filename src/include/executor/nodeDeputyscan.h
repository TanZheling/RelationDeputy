 ...
 *
 * src/include/executor/nodeDeputyscan.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef NODEDEPUTYSCAN_H
#define NODEDEPUTYSCAN_H

#include "access/genam.h"
#include "access/parallel.h"
#include "nodes/execnodes.h"

extern DeputyScanState *ExecInitDeputyScan(DeputyScan *node, EState *estate, int eflags);
